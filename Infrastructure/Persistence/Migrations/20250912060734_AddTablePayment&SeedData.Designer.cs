...
namespace Dapper_StoredProcedures.Migrations
{
    ...
    [Migration("20250912060734_AddTablePayment&SeedData")]
    partial class AddTablePaymentSeedData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dapper_StoredProcedures.Entities.Payment", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dapper_StoredProcedures.Entities.Payment", b =>
                {
                    b.HasOne("Dapper_StoredProcedures.Entities.Order", null)
                        .WithOne()
                        .HasForeignKey("Dapper_StoredProcedures.Entities.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
